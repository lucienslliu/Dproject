...
/**
*/
Shape::Shape(ThreadId threadId_, Type shapeType_, const matrix44& modelTransform_, const float4& color_) :
    threadId(threadId_),
...
*/
void
Shape::SetupSimpleShape(ThreadId threadId_, Type shapeType_, const matrix44& modelTransform_, const float4& color_)
{
...
*/
void
Shape::SetupPrimitives(ThreadId threadId_, const Math::matrix44& modelTransform_, PrimitiveTopology::Code topology_, SizeT numPrimitives_, const void* vertices_, SizeT vertexWidth_, const Math::float4& color_)
{
    n_assert(!this->IsValid());
...
*/
void
Shape::SetupIndexedPrimitives(ThreadId threadId_, const Math::matrix44& modelTransform_, PrimitiveTopology::Code topology_, SizeT numPrimitives_, const void* vertices_, SizeT numVertices_, SizeT vertexWidth_, const void* indices_, IndexType::Code indexType_, const Math::float4& color_)
{
    n_assert(!this->IsValid());
