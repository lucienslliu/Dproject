...
{
    this->shapes.Append(Shape(Thread::GetMyThreadId(), Shape::Box, modelTransform, color));
}
...
{
    this->shapes.Append(Shape(Thread::GetMyThreadId(), Shape::Sphere, modelTransform, color));
}
...
{
    this->shapes.Append(Shape(Thread::GetMyThreadId(), Shape::Cylinder, modelTransform, color));
}
...
{
    this->shapes.Append(Shape(Thread::GetMyThreadId(), Shape::Torus, modelTransform, color));
}
