...
TriggerProperty::SetupDefaultAttributes()
{
    ...
    this->GetEntity()->AddBool(Attr::TriggerActive);
    this->GetEntity()->AddBool(Attr::OneWayTrigger);
    this->GetEntity()->AddFloat(Attr::TriggerTimeStamp);
    this->GetEntity()->AddFloat(Attr::EntityTriggerRadius);
    this->GetEntity()->AddFloat(Attr::TriggerPhaseTime);
    this->GetEntity()->AddBool(Attr::ReactivateTrigger);
    this->GetEntity()->AddFloat(Attr::ReactivateTriggerTime);
}
...
TriggerProperty::SetCurrentEntitiesInTrigger()
{
    ...
    {
        const Ptr<Physics::PhysicsEntity>& entity = contacts[i].GetEntity();
